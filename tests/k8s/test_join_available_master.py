...
def test_join_available_master(duthost, k8scluster):
    ...
    pytest_assert(server_connect_exp_status == server_connect_act_status,
                  "DUT shows unexpected kubernetes server connected status, Expected server connected status: {}, "
    ...
    pytest_assert(server_connect_status_updated,
